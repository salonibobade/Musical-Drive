 ...
 var $this = $(this);
    ...
    switch ($this.text())
    {
        ...
        case 'Great Wall Of China':
            player.loadVideoById('do1Go22Wu8o');
            vid.href = 'https://www.youtube.com/watch?v=do1Go22Wu8o';         
            break;
        case 'Petra':
            player.loadVideoById('ezDiSkOU0wc');
            vid.href = 'https://www.youtube.com/watch?v=ezDiSkOU0wc';         
            break;
        case 'Colosseum':
            player.loadVideoById('hxpBPStoIZ8');
            vid.href = 'https://www.youtube.com/watch?v=hxpBPStoIZ8';         
            break;
            case 'Chichen Itza':
                player.loadVideoById('0PqTqcGoS0w');
                vid.href = 'https://www.youtube.com/watch?v=0PqTqcGoS0w';         
                break;
            
            case 'Machu Picchu':
                player.loadVideoById('Zk9J5xnTVMA');
                vid.href = 'https://www.youtube.com/watch?v=Zk9J5xnTVMA';         
                break;
            
            case 'Taj Mahal':
                player.loadVideoById('kE8wPv-JdOA');
                vid.href = 'https://www.youtube.com/watch?v=kE8wPv-JdOA';         
                break;
            
            case 'Christ the Redeemer':
                player.loadVideoById('hpoGtOfZoYY');
                vid.href = 'https://www.youtube.com/watch?v=hpoGtOfZoYY';         
                break;
                
                           
                
            case 'Mount everest':
                player.loadVideoById('NhBzhi9jPFs');
                vid.href = 'https://www.youtube.com/watch?v=NhBzhi9jPFs';         
                break;
    
            case 'K2 karakoram':
                player.loadVideoById('v9yeBSdsrqE');
                vid.href = 'https://www.youtube.com/watch?v=v9yeBSdsrqE';         
                break;
    
            case 'Kangchenjunga, Himalayas':
                player.loadVideoById('GBk3f5XKTWs');
                vid.href = 'https://www.youtube.com/watch?v=GBk3f5XKTWs';         
                break;
            case 'Frozen methane bubbles':
                player.loadVideoById('i8Jf0XFNkS4');
                vid.href = 'https://www.youtube.com/watch?v=i8Jf0XFNkS4';         
                break;
            case 'Sailing Stones':
                player.loadVideoById('NbLnwAC3FPQ');
                vid.href = 'https://www.youtube.com/watch?v=NbLnwAC3FPQ';         
                break;
            case 'Northen lights':
                player.loadVideoById('fVsONlc3OUY');
                vid.href = ' https://www.youtube.com/watch?v=fVsONlc3OUY';         
                break;
    }
})
